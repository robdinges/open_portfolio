...
| OE-GAP-005 | Persistente order-draft opslag | Tijdelijke in-memory draft repository | Conceptorders verdwijnen bij restart | Must | src/open_portfolio/database.py, src/open_portfolio/order_entry.py |
...
- OE-GAP-005: gedeeltelijk opgeleverd.
  ...
  - Restpunt: formeel migratie- en bewaarbeleid documenteren in runbook/procedures.
